...
local Main_AutoEggs = Win:Tab("• AutoEggs", "")
...
--// Eggs
local AutoEggs = Main_AutoEggs:NewSection("Auto Eggs")
AutoEggs:Line()
local eggs = {}
...
AutoEggs:Dropdown("Select Egg", "None", eggs, function(v)
    config.egg = v
end)
AutoEggs:Toggle("Auto Egg", false, function(v)
    flags.autoegg = v
        if v then
