...
local Main_Eggs = Win:Tab("• AutoEggs", nil)
local Main_Teleport = Win:Tab("• Teleport", nil)
local Main_Misc = Win:Tab("• Miscs", nil)
local Main_Settings = Win:Tab("• Settings",  nil) 
...
Home:Button("Credits", function()
    Blacklib:Notification("PSX Gui made by itstermoh")
end)
